...
export const CompanyDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="drugwikiApp.company.delete.question">Are you sure you want to delete this Company?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="dgw-confirm-delete-company" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
