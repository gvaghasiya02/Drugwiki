...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGREDIENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INGREDIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INGREDIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INGREDIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INGREDIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INGREDIENTS actions', async () => {
      const expectedActions = [
        {
