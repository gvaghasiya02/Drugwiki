package com.promition.drugwiki.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.promition.drugwiki.IntegrationTest;
import com.promition.drugwiki.repository.timezone.DateTimeWrapper;
import com.promition.drugwiki.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM dgw_date_time_wrapper where id=%d", fieldName, id);
    }
